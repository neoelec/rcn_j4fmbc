...
V20-MBC-ATMEL1284 Fork of S260320-R230520 - improves readability adds support for ATMega 1284(p)
...
#define   MAX_RD_CLKPULSES      10                  // Max clock pulses before finding a Read Bus Cycle
...
// ------------------------------------------------------------------------------
  ...
  Serial.print(F("IOS: V20 clock set at "));
  ...
  TCCR2A &= ~(1 << COM2A1);
  OCR2A = clockMode;                            // Set the compare value to toggle OC2 (1 = low or 0 = high)
